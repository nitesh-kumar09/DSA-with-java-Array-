// Using Binary search, search the element in the first half of an array.

import java.util.Scanner;
class BinarySearchFirstHalf {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Element found at index : "+(BinarySearchFirstHalf.binarySearch(arr , 0 , (arr.length-1)/2 , key)));
